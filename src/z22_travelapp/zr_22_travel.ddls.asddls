...
define root view entity ZR_22_Travel
  as select from z22_atravel
  composition [0..*] of ZR_22_Booking as _Bookings
  association to ZI_22_CustomerText as _CustomerText on z22_atravel.customer_id = _CustomerText.CustomerId
{
