CLASS z22_travel_generator DEFINITION
...
CLASS z22_travel_generator IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DATA travel TYPE z22_atravel.

    DATA travels TYPE TABLE OF z22_atravel.

    DATA booking TYPE z22_abooking.

    DATA bookings TYPE TABLE OF z22_abooking.



    "DBT löschen

    DELETE FROM z22_atravel.

    DELETE FROM z22_abooking.
    ...
    travel-description = 'Sylvesterausflug nach New York'.
    ...
    INSERT z22_atravel FROM TABLE @travels.

    INSERT z22_abooking FROM TABLE @bookings.
