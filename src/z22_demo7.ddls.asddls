...
define view entity Z22_demo7
  as select from     /dmo/flight
    right outer join /dmo/connection             on  /dmo/flight.carrier_id    = /dmo/connection.carrier_id
                                                 and /dmo/flight.connection_id = /dmo/connection.connection_id
    right outer join /dmo/airport as AirportFrom on /dmo/connection.airport_from_id = AirportFrom.airport_id
    right outer join /dmo/airport as AirportTo   on /dmo/connection.airport_from_id = AirportTo.airport_id
{
